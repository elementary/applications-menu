		...
		*/
		...
		public class Logger {
			...
			private static void initialize () {
				var levels = LogLevelFlags.LEVEL_DEBUG | LogLevelFlags.LEVEL_INFO | LogLevelFlags.LEVEL_WARNING | LogLevelFlags.LEVEL_CRITICAL | LogLevelFlags.LEVEL_ERROR;
				string[] domains = {
					"Synapse",
					"Gtk",
					"Gdk",
